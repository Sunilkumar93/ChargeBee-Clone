...
const Login = () => {
  ...
  return (
    <Box pt="110px" pb="100px" bg="white" color="black" >
      <Grid gridTemplateColumns={{base:"1fr",md:"1fr 1fr"}} className='login_outer' width={{base:"90vw",md:"70vw",lg:"70vw"}}  m="auto"  boxShadow='dark-lg' gap={10}  rounded='md' bg='white' >
        <Show above="md">
          <Box m="40px 20px 40px 40px" className='login_left' >
              ...
              <Text cursor="pointer" mt="10px" color="blue" >See what's new across our products</Text>
          </Box>
        </Show>
          ...
          <Box  m="40px 40px 40px 20px" className='login_right' >
            ...
            <form onSubmit={loginFirebase} >
              ...
              <Button _hover={{bg:"#f67d19",color:"white"}} type="submit" bg="#f67d19" mt="20px" px="20px" color="white" >Sign in</Button>
              <Box><a href="#">Forgot password?</a></Box>
              </Flex>
              <Box mb="20px">
              <Link  mb="20px" to='/signup'  >Don't have an Account <span style={{color:"blue"}}> Click here</span></Link>
              </Box>
            </form>
            <hr />
            <Box mt="30px" justifyContent="center" display="flex" >
            <Button color="white" bg="#4285f4"   borderRadius="0px" width="80%"  colorScheme='google' leftIcon={<GoogleIcon/>}>Sign in With Google</Button>
            </Box>
