    ...
    <Box pt="80px"   color="black">
       <Grid gridTemplateColumns={{base:"1fr",md:"1fr",lg:"1fr 2fr"}} >
        ...
        <Box className='left' bg="#500ad2" >
          <Box bg="white" px="60px"><Image src="https://webstatic.chargebee.com/assets/web/543/images/signup/customers/dailius-wilson-getaccept.png" alt="signup_logo"/></Box>
          <Box textAlign="center" py="30px" bg="#38039a" color="white" >
              <Heading size='lg'>Dailius Wilson</Heading>
              <Text>VP Sales & Growth</Text>
          </Box>
          <Flex flexDir="column"  m="auto" justifyContent="center" textAlign="center" px="50px" bg="#500ad2" color="white" pt="25%" >
            <h1>Chargebee is a fantastic solution that really meets the needs of any SaaS business. Our revenue grew 4x in 12 months, using Chargebee.</h1>
            <Box mt="20px"><Image w="50%" m="auto" src="https://f.hubspotusercontent00.net/hubfs/541808/Logotype%202020/GA_Logotype_2020_Neg.png" /></Box>
          </Flex>
            ...
            <fieldset style={{border:"1px solid gray",paddingLeft:"20px",margin:"10%",borderRadius:"10px",padding:"5%"}}>
              ...
              <Box  h="100%">
                ...
                <input type="checkbox" borderColor="gray.400"  />
                  <Text fontSize="14px">I want to be notified about the awesome happenings* at Chargebee</Text>
                </Flex>

                <Input mb="40px" size="lg"  type="submit" value="Complete Signup &#8594;" bg="#500ad2" color="white" fontWeight="bold" />
