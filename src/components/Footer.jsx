      ...
      <Container as={Stack} maxW={"7xl"} py={10}>
        <SimpleGrid columns={{ base: 1, sm: 2, md: 2, lg: 4 }} spacing={8}>
          <Stack align={"flex-start"}>
            <Box bg="#fff" color="#38039a">
              <Heading size="md" opacity=".75" style={{ fontWeight: "bolder" }}>
                Product &#62;
              </Heading>
            </Box>
          ...
          <Stack align={"flex-start"}>
            ...
            <Box bg="#fff" color="#38039a">
              <Heading opacity=".75" size="md" style={{ fontWeight: "bolder" }}>
                Company &#62;
              </Heading>
            </Box>
        ...
        <Flex pb="10%" px="5%" justifyContent="space-between">
          <Box>
            <Image
              w="30%"
              borderRadius="20%"
              src="https://cyclr.com/wp-content/uploads/2018/10/chargebee-logo.png"
              alt="footer-logo"
            />
          </Box>
          <Flex gap={4}>
